...
function doGithub(file, filename) {
	file.github = {
		'blob': 'https://github.com/cs125-illinois/www-old/blob/master/src/' + filename,
		'commits': 'https://github.com/cs125-illinois/www-old//commits/master/src/' + filename,
		'commit_id': git.short(),
		'commit': 'https://github.com/cs125-illinois/www-old/commit/' + git.long()
	}
	return;
};
