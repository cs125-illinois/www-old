...
technologist.
//
At first the command line seems crufty, old-fashioned, and difficult to learn.
//
But once you get good at it it allows you to accomplish many more things that
you can do using graphical interfaces, and accomplish those things faster and
more accurately.
//
...
//
We've also left things quite underspecified and open-ended.
//
This is intentional.
//
...
[[virtualbox]]
=== Install VirtualBox [.text-muted]#(15 Minutes)#
...
[[linux]]
=== Install Linux [.text-muted]#(15 Minutes)#
...
Ubuntu 16.0.4, which is a so-called long-term support release.
//
...
//
But if you can accept the tradeoffs, feel free to give them a try:
...
potentially irrepairable damage to your machine.*
//
. All verisons of Windows have their own terminal program, but it's extremely
unpleasant to use.
//
...
[[exercises]]
== Command Line Exercises [.text-muted]#(50 Minutes)#
...
=== Practice Using Subversion and Git
...
[[mp7]]
== MP7 Brainstorming [.text-muted]#(30 Minutes)#
