...
[[cloning]]
=== Forking and Cloning the Lab3 IntelliJ Project

Follow the
//
link:/lab/2#cloning[instructions from Lab 2]
//
to fork a copy of our
//
https://github.com/cs125-illinois/Lab3[Lab3 GitHub repository].
...
//
Just to set up a few defaults for you, and because we want you to keep using
`checkstyle`.
...
For Lab 3 we want you to commit and push your changes to the new GitHub
repository that you created above.
//
You should be familiar with this process from link:/MP/0/[MP0] and
link:/MP/1/[MP1].
