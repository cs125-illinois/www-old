...
Create a copy of
//
https://goo.gl/j1VC12[our document template]
//
...
working with the Pokémon objects that we introduced in link:/lab/2018/fall/4/[Lab 4].

=== Forking and Cloning the Lab6 IntelliJ Project

We've set up an
//
https://github.com/cs125-illinois/Fall-2018-Lab6[Lab 6 GitHub repository]
//
...
Use any remaining time in your lab section to get help with link:/MP/2018/fall/3/[MP3].
