...
We've set up an
//
https://github.com/cs125-illinois/Fall-2018-Lab2[Lab 2 GitHub repository]
//
...
. You
//
link:/MP/2018/fall/setup/git#submitting[push your work to GitHub].
//
