...
link:/MP/2018/spring/setup/java/[Java] and link:/MP/2018/spring/setup/intellij[IntelliJ], and walk
...
//
link:/info/2018/spring/syllabus/#tas[teaching assistant],
//
and to the link:/info/2018/spring/syllabus/#cas[volunteer course assistants]
//
