...
We've set up an
//
https://github.com/cs125-illinois/Spring-2018-Lab8[Lab 8 GitHub repository]
//
...
//
https://cs125-illinois.github.io/Spring-2018-Lab8/[Lab8 documentation] helpful.
...
Use any remaining time in your lab section to get help with link:/MP/2018/spring/5/[MP6].
