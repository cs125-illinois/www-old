...
//
Finally we've set aside time for you to get started on link:/MP/3/[MP3] which is due
_next Friday_!

[[csv]]
== CSV [.text-muted]#(60 Minutes Total)#

Both today's lab and link:/MP/3/[MP3] introduce you to different ways of
...
//
link:/MP/3/[MP3] introduces you to
//
link:/MP/3/#json[JSON], a powerful way to convert Java objects
//
...
//
link:/MP/3/#apis[Cognitive Services API setup done].
//
...
//
. You've made some more progress on link:/MP/3/[MP3]...
//
