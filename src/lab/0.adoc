...
[.alert.alert-warning]
--
**If this doesn't work for you yet, sit tight.**
//
It should be fixed soon, and we don't start counting participation until the
third week of class.
//
However, you will need to log into Discourse differently below.
//
--
...
==== If your Google Apps Integration isn't working yet...

[.alert.alert-warning]
//
--
//
If your <<google, Google Apps Integration>> isn't available yet, you should
following the following steps to gain access to the forum:
//
--

. Browse to https://cs125-forum.cs.illinois.edu/
//
. Click on "Log In" and then "with email"
//
. Click on "I forgot my password" and enter your `@illinois.edu` email
//
. You should receive a password reset email shortly. Use it to set your password
and you should be good to go.
//

==== Let yourself in and look around
...
//
--
Unfortunately our grading page _will not work_ if your Google Apps Integration
isn't working.
//
Sorry!
//
