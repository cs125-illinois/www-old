...
//
We'll make sure you can access the forum and participate in lecture, look at
how to do the online homeworks, and begin preparing you to work on our first MP
...
//
Note that the online gradebook looks quite different now than when it did when
