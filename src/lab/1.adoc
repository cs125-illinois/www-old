...
//
https://prairielearn.engr.illinois.edu/pl/course_instance/52292/assessment_instance/1332382[in-lab homework].
//
**You will only be able to access this homework beginning 10 minutes after your
lab starts and ending 2 hours later.**
//
So if your lab starts at 9AM, you can start the homework at 9:10AM and should
complete it by 11AM, providing you with some time to complete the problem after
lab if you need it.
//
...
Please feel free to work with one or more of your lab mates to complete the
in-lab homework.
//
