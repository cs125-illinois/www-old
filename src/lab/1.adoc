...
//
All of the examples in the `src/main/java` folder are runnable, although you
...
completely possible.
//
We'll leave that to you to figure out&mdash;although an audio walkthrough does
follow.
