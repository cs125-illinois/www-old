...
The purpose of MP3 is begin introducing you to object-oriented programming.
//
...
. *10 points* for committing code that earns at least 40 points before *Friday
2/23/2018 @ 5PM.*
...
And remember, you must commit something that earns 40 points before *Friday
