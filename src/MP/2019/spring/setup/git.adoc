...
//
link:/MP/2019/spring/setup/android-studio/[installed Android Studio]
//
...
//
link:/MP/2019/spring/setup/android-studio/[Android Studio IDE]
//
and
//
...
It should look like
//
link:https://github.com/cs125-illinois-students/MP0-Spring2019-username.git[https://github.com/cs125-illinois-students/MP0-Spring2019-username.git, role="noclick link_exception"],
//
...
on GitHub.**
//
These will result in an incorrect project setup that is hard to fix.
