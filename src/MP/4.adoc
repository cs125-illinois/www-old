...
Like link:/MP/3/[MP3], MP4 consists of a simple client-server system.
//
...
We suggest that you _do not_ try to interpret the staticly initialized arrays in
