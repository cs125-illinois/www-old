...
Software".
//
. Work with link:http://download.eclipse.org/buildship/updates/e46/releases/2.x/[http://download.eclipse.org/buildship/updates/e46/releases/2.x/[https://subversion.ews.illinois.edu/svn/fa17-cs125/challen,role="noclick"]
//
and click "Add".
//
