...
Software".
//
. Work with http://community.polarion.com/projects/subversive/download/eclipse/6.0/update-site/
//
and click "Add".
//
...
Software".
//
. Work with http://download.eclipse.org/buildship/updates/e46/releases/2.x/
//
and click "Add".
//
