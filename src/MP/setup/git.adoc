...
It should look like
//
link:https://github.com/cs125-illinois-students/MP-Fall2019-username.git[https://github.com/cs125-illinois-students/MP-Fall2019-username.git, role="noclick link_exception"],
//
