...
On newer versions of IntelliJ, starting from the main menu you can also click on
"Plugins", then choose "Browse Repositories", and then search for "checkstyle"
to install the plugin over the internet.
