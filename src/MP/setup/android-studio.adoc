...
[.alert.alert-warning]
--
**Note that the we are still waiting for our latest plugin revision (0.2.1) to
be approved by JetBrains for use with Android Studio 3.3.**
//
We will post on the forum when the plugin is available.
//
--
