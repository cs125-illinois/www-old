...
:forum: pass:normal[https://cs125-forum.cs.illinois.edu/c/mps/fall2018-mp2[forum,role='noexternal']]
...
//
Note that, unlike link:/MP/2018/fall/1/[MP1], you have to do a bit more work on MP2 to get
to 20 points.
...
We'll also continue to reinforce the learning objectives from link:/MP/2018/fall/0/[MP0]
and link:/MP/2018/fall/1/[MP1].
...
. https://cs125-illinois.github.io/Fall-2018-MP2-Starter/Anagram.html[`Anagram.java`]:
//
determines if two strings are anagrams.
//
You will need to complete this function.
//
. https://cs125-illinois.github.io/Fall-2018-MP2-Starter/CheckPassword.html[`CheckPassword.java`]:
//
checks if a password meets certain requirements.
//
You will need to declare and complete this function.
//
. https://cs125-illinois.github.io/Fall-2018-MP2-Starter/StringSplitter.html[`StringSplitter.java`]:
//
splits a string whenever the character changes.
//
You will need to declare, complete, and document this function.
//
. https://cs125-illinois.github.io/Fall-2018-MP2-Starter/TimesTable.html[`TimesTable.java`]:
//
...
//
https://cs125-illinois.github.io/Fall-2018-MP2-Starter/package-summary.html[MP2 online documentation]
//
...
link:/MP/2018/fall/0/#requirements[MP0] and link:/MP/2018/fall/1/#requirements[MP1].
//
MP2 is similar.
//
However, unlike link:/MP/2018/fall/0/[MP0] and link:/MP/2018/fall/1/[MP1] you no longer get free
...
All of the link:/MP/2018/fall/0/#approach[MP0] and link:/MP/2018/fall/1/#approach[MP1] about how to
...
language `printf` statement]&mdash;it's
//
...
Note that, unlike link:/MP/2018/fall/1/[MP1], you do need to do a bit of work to get to 20
points, since there are no free points for just getting things to compile.

[[testing]]
=== Test Cases

Like link:/MP/2018/fall/0/[MP0] and link:/MP/2018/fall/1/[MP1], we have provided exhaustive test cases
...
Like link:/MP/2018/fall/0[MP0] and link:/MP/2018/fall/1/[MP1], we have provided you with an
