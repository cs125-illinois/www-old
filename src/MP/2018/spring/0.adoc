...
:forum: pass:normal[https://cs125-forum.cs.illinois.edu/c/mps/spring2018-mp0[forum,role='noexternal']]
...
//
link:/MP/2018/spring/setup/git#workflow[CS 125 Git workflow].
//
