...
public class Example {
  public static void main(String[] unused) {
    Tree tree = new Tree(new Integer[] { 1, 2, 5, 8, 9 });
...
//
* Note that we _will_ have class on the Friday before Thanskgiving but _not_ on
the Wednesday before Thanksgiving.
//
As usual, the link:/info/#calendar[calendar is up-to-date].
//
* We've added an
//
