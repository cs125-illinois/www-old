...
[[jNMJwETWXSWbAxQzVcqVQuVwMheKUskW]]
== Split Name
...
[[IxHApLsXKcBfXRTvZGwXTFwkYaFKdDZs]]
== ! Split Name
...
[[YemcmnNYbOtEtuBEGbKHhmEPGqaxnAqs]]
== Search Text

[.lead]
//
Given a line of text, write a function that searches for all occurences of a
given word.

[[rnEWJyzismEfUrHNeZpIfIdwIJEQonpb]]
== ! Search Text
