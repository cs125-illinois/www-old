...
spelling_exceptions:
  ...
  - rethrow
  - Rethrowing
youtube: https://youtu.be/q2hRXro-fxc
---
...
[.lead]
//
https://www.youtube.com/watch?v=WrpBgN_iUnA["If I don't get out, out of this
town&mdash;I just might be the one to burn it down."]
//
I'm sure maybe a few of us are feeling that way right about now, except
substitute "house" for "town".

I'm not surprised that I like the new song by
//
https://www.thekillersmusic.com/[The Killers].
//
I was, however, surprised by how good they live from their bathroom on
//
https://www.youtube.com/watch?v=ZT4h9M49s40[Jimmy Kimmel].
...
* Material from today's class _is_ covered on Wednesday's quiz.
//
