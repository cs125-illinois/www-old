...
description:
  ...
  and data modeling.
youtube: https://youtu.be/6Mmv7QBzVok
---
...
cs125.name = "CS 125";
cs125.semester = "Spring2020";
cs125.enrollment = 500;
System.out.println(cs125.name + " has "
                   + cs125.enrollment + " students in "
                   + cs125.semester
);
....
--
...
[[uigiOIeJXemeUNqqICjGZgiOdNDeFKxe]]
== Or Not `this`
...
[.lead]
//
But instance methods _can also_ refer to _their_ instance variables _without_
using the `this` keyword.

[[freAdczfjCduMgvVUzcqxhGHwNeIUfZn]]
== ! Not `this`
