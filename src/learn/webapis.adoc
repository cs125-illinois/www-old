...
spelling_exceptions:
  ...
  - transformative
  - mockup
youtube: https://youtu.be/UvuJ7Yd77EE
---
...
[.lead]
//
I hope you are all finding some
//
https://www.youtube.com/watch?v=nDGYV82lAFI["beauty in the broken American
moment."]
...
//
http://www.hissgoldenmessenger.com/[Hiss Golden Messenger].
