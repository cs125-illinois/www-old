...
youtube: https://youtu.be/r1mxrczIzF0
---
...
[.small]
//
* Homework continues today and is now due _the day it is assigned_.
//
...
//
* I will _not_ hold afternoon office hours today&mdash;I'm helping finish up the
machine project for release on Friday.
//
