...
youtube: https://youtu.be/t93WqX0vhg8
---
...
[[NQWSKBLVRITBVHRIUJPBNECDIIMTVKPQ]]
== Homework Progress
...
//
* link:/MP/2018/fall/0/[MP0] is out. Get started!
//
* link:/info/resources/#hours[Office hours] start up
again tomorrow.
//
